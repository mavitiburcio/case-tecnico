...
import { ArrowLeft, Bell, CheckCircle, Clock, AlertTriangle, Package } from "lucide-react"
...
export default function NotificacoesColaborador() {
  const [notificacoes, setNotificacoes] = useState([
    {
      id: 1,
      tipo: "entrega",
      titulo: "Seu brinde está a caminho!",
      mensagem: "O Kit Verão 2024 foi despachado e chegará em breve",
    ...
    },
    {
      ...
      mensagem: "Você recebeu a Caneca Personalizada? Confirme o recebimento",
    ...
    },
    {
      ...
      mensagem: "Mantenha seu endereço atualizado para receber seus brindes",
    ...
    },
    {
      ...
      mensagem: "Você foi selecionado para a campanha Kit Verão 2024",
      data: "2024-01-13T11:10:00",
      lida: true,
      prioridade: "normal",
    },
    {
      id: 5,
      tipo: "feedback",
      titulo: "Avalie seu último brinde",
      mensagem: "Como foi sua experiência com a Agenda 2024?",
      data: "2024-01-12T08:00:00",
      lida: true,
      prioridade: "baixa",
    },
  ])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <Card className="rounded-lg shadow-sm">
          <CardHeader>
            <CardTitle className="corporate-blue-text">Suas Notificações</CardTitle>
            <CardDescription>Acompanhe atualizações sobre seus brindes e campanhas</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div key={notificacao.id}>
                  <div
                    className={`p-4 rounded-lg border cursor-pointer transition-colors ${
                      !notificacao.lida ? "bg-blue-50 border-blue-200" : "bg-white hover:bg-gray-50"
                    }`}
